...
Only exercises `list_open_issues` (read-only) against `blakeboswell/eigen`
...
from eigen.github import list_open_issues

pytestmark = pytest.mark.integration


def test_list_open_issues_against_real_repo() -> None:
    issues = list_open_issues("blakeboswell/eigen")
